...
public class NN4jMultiClassClassifier extends ClassifierBase implements IClassProbabilityClassifier, java.io.Serializable {
    ...
    public NN4jMultiClassClassifier() {}

    public NN4jMultiClassClassifier(JSONObject configuration) {
        this();
        _model = createNetworkFromConfig(configuration);
    }

    public NN4jMultiClassClassifier(String modelFilePath) {
        this();
        try {
    ...
    public NN4jMultiClassClassifier(MultiLayerNetwork model) {
        _model = model;
    }
    ...
    public IClassifier fitNew(DoubleMatrix2D x, double[] y) {
        internalFit(x, y);
        return new NN4jMultiClassClassifier(_model);
    }
