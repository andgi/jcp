 ...
 */
public class FuzzinessCriterion implements IPriorMeasure
{
    private static final String NAME = "Fuzziness criterion";

    /**
     * Computes the F/Fuzziness criterion measure for this prediction.
     * @param prediction the prediction.
     * @return the Fuzziness criterion measure for this prediction. Small values are preferable.
     */
    @Override
    public double compute(ConformalClassification prediction)
    {
        ...
        return sum - prediction.getPointPredictionCredibility();
    }
